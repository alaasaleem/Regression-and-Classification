...
for degree in range(1, 11):
    ...
    legend = ax.legend(fontsize=12, facecolor='black', edgecolor='white', prop={'family': 'Times New Roman', 'weight': 'bold'})
    ...
    ax.text2D(0.05, 0.75, f'Training Error: {train_error:.4f}\nValidation Error: {val_error:.4f}',
